    ...
    content: [
      {
        ...
        items: [
          ...
          { emoji: '🏦', name: 'Código de Banco', desc: 'Nome completo e dados do banco pelo código compensação.' },
          { emoji: '📦', name: 'NCM', desc: 'Nomenclatura Comum do Mercosul (código fiscal de produto).' },
